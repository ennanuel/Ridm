...
const Track = ({ scrolled, isPlaying, isActive, activeSong, imageRef, onLoad, text }) => (
  <div className="flex-1 flex items-center justify-start relative">
    ...
    <div className="flex-1 max-w-[250px]">
      <p style={{color: !scrolled && text}} className="truncate text-gray-200 font-bold text-[0.65rem] sm:text-md">
        {activeSong?.title ? activeSong?.title : 'No active Song'}
      </p>
      <p style={{color: !scrolled && text}} className="truncate text-gray-400 font-semibold opacity-80 text-[0.6rem] sm:text-xs">
