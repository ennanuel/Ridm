...
const Track = ({ activeSong, handleClick, duration, appTime, setSeekTime }) => {
  return (
    <>
    <img src={activeSong?.album?.cover_big} className="md:w-[70%] lg:w-[50%] w-[90%] aspect-square rounded-lg bg-white/10 shadow-lg shadow-black/50" />
    <div className="w-[90%] md:w-[70%] lg:w-[50%] flex flex-col gap-1" onClick={handleClick}>
    ...
    <div className="md:w-[70%] lg:w-[50%] w-[90%] flex flex-col gap-3">
