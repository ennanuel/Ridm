...
const Track = ({ activeSong, handleClick, duration, appTime, setSeekTime }) => {
  return (
    <>
    <img src={activeSong?.album?.cover_big} className="w-[70%] aspect-square rounded-lg bg-white/10 shadow-lg shadow-black/50" />
    <div className="w-[70%] flex flex-col gap-1" onClick={handleClick}>
