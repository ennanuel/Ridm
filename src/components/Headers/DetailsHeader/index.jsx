...
const DetailsHeader = () => {
  ...
  return (
    <div
      className="transition-[box-shadow] relative h-[60vh] w-full flex flex-col justify-end mt-[-60px]"
    >
      ...
      {bg && <div style={{ background: `linear-gradient(transparent 30%, ${bg})`}} className="absolute block w-full h-full"></div>}
      {
        isFetching ?
        <HeaderLoading /> :
        error ?
