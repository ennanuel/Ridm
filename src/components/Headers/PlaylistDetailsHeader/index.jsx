...
const PlaylistDetailsHeader = ({playlist, songsToBeDeleted, editData, handleEdit, handleDelete, setParams, params, handleChange}) => {
  return (
    <div style={{background: "var(--color)"}} className="min-h-[30vh] lg:pt-[80px] relative shadow-lg shadow-black/40 flex flex-col md:flex-row gap-4 items-start md:items-end justify-start p-6 overflow-x-clip">
