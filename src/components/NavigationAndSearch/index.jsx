...
const NavigationAndSearch = ({ goFront, goBack, scrolled, scrolledUp, isPlaying, activeSong }) => {
  ...
  return (
  <div style={style} className={`flex flex-row items-center justify-between gap-5 z-10 top-0 left-0 sticky transition-[background-color,transform] ${scrolled ? 'bg-[#151515]' : 'bg-transparent'} ${scrolledUp && 'translate-y-[-100%] lg:translate-y-[0]'}`}>
