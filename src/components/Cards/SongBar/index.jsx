...
const SongBar = ({ tracks, song, i, artistId }) => {
  ...
  const handlePlayClick = () => {
    playSongs({dispatch, song, tracks, i})
  }


  return (
    <div style={{'--delay': i/20 + 's'}} className={`song-bar animate-slowfade ${song.id === activeSong?.id && 'active-song'} flex flex-row items-center hover:bg-white/5 transition-colors p-[5px] pr-5 rounded-[3px] cursor-pointer`}>
