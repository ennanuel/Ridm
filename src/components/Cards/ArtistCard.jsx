...
const ArtistCard = ({ artist, i }) => {
  ...
  return (
    <div style={{'--delay': i/20 + 's'}} className="artist-card flex flex-col p-2 md:p-3 rounded-md cursor-pointer transition-[background-color] hover:bg-white/5" onClick={() => { navigate(`/artists/${artist.id}`) }}>
