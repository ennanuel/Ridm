...
const ArtistCard = ({ artist, i }) => {
  ...
  return (
    <div style={{'--delay': i/20 + 's'}} className="artist-card flex flex-col p-2 rounded-sm cursor-pointer transition-[background-color] hover:bg-white/5 shadow-lg shadow-black/50" onClick={() => { navigate(`/artists/${artist.id}`) }}>
