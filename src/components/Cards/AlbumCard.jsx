...
const AlbumCard = ({ album, i, isRelated, isRecent, activeSong, isPlaying }) => {
    ...
    return (
        <div 
            style={{'--delay': (i/10) + 's'}} 
            onClick={handleClick} 
            className="album-card p-2 relative shadow-sm shadow-black/50 flex flex-col flex-1 hover:bg-white/5 transition-[background-color,top] top-0 hover:top-[-10px] cursor-pointer"
        >
